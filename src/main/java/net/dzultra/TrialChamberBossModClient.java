...
import net.dzultra.entity.client.ChainPillarEntityModel;
...
public class TrialChamberBossModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityModelLayerRegistry.registerModelLayer(ChainPillarEntityModel.CHAIN_PILLAR, ChainPillarEntityModel::getTexturedModelData);
